        ...
        <div class="content-container-1">
            ...
            <div id="grid">
                ...
                <div id="text-container">
                    ...
                    <button style="width: 130px; height: 30px; background-color: var(--color10); border: 0; margin-bottom: var(--space-xl);"></button>
                </div>
            </div>
        </div>
    </div>
...
<style scoped>
    ...
    div.content-container-1, div#grid {
        height: inherit;
    }
