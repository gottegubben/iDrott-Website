<script setup lang="ts">
    import iDrottLogo from '../../assets/icons/iDrottLogo.vue';
</script>
...
<style scoped>
    div#img-container {
        ...
        /* There should be a max size where the image doesn't have to scale. At least the height because imagine a super high cropped image... */
        max-height: none;
        max-width: none;
    }
    img#start {
