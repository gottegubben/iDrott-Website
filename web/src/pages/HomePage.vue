<template>
    ...
    <div style="margin: var(--space_xxl_clamped) 0;">
        <BaseLayout>
            <div id="title_container" style="display: flex; flex-direction: column; align-items: center; margin-bottom: var(--space_xxl_clamped);">
